...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "${REPO}ssh/badvpn"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/zheevpn/a/main/ssh/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/ZvnStores/stores/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
